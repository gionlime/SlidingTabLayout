...
package com.legendmohe.tablayout;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link SlidingTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link SlidingTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    /**
     * Returns the current mode used by this {@link SlidingTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @Mode
    ...
    /**
     * The one-stop shop for setting up this {@link SlidingTabLayout} with a {@link ViewPager}.
     *
    ...
    public static final class Tab {
        ...
        private SlidingTabLayout mParent;
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        SlidingTabStrip(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            mSlidingDrawable = a.getDrawable(R.styleable.SlidingTabLayout_slidingBackground);
...
//            }
        ...
        protected void onDraw(Canvas canvas) {
            super.onDraw(canvas);
            if (mSlidingDrawable != null && mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                mSlidingDrawable.setBounds(mIndicatorLeft, 0, mIndicatorRight, getHeight());
                mSlidingDrawable.draw(canvas);
            }
        }
    }
     ...
     * necessary calls back to the provided {@link SlidingTabLayout} so that the tab position is
     * kept in sync.
     *
     * <p>This class stores the provided MyTabLayout weakly, meaning that you can use
    ...
    public static class MyTabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public MyTabLayoutOnPageChangeListener(SlidingTabLayout tabLayout) {
        ...
        public void onPageScrolled(int position, float positionOffset,
            ...
            final SlidingTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link SlidingTabLayout.OnTabSelectedListener} class which contains the necessary calls back
     * to the provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements SlidingTabLayout.OnTabSelectedListener {
